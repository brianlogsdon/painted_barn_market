...
function (_Component) {
  ...
  _createClass(HomePage, [{
    key: "render",
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_styles_HomeStyle__WEBPACK_IMPORTED_MODULE_1__["default"], {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 21
        },
        ...
        src: "https://i.pinimg.com/originals/a3/40/a1/a340a19500dd6abcc59bf1c270a70226.jpg",
        alt: "First slide",
        __source: {
          fileName: _jsxFileName,
          lineNumber: 24
        ...
        __self: this
      }, "Lorem ipsum dolor sit amet, ei nam ferri volumus praesent, quo ut solum ubique conclusionemque. Et euismod tacimates prodesset sea, vel quem nibh possit no. Inani constituam id duo, ut quo vitae discere."))));
    }
  }]);
...
})(["background:white;background-repeat:no-repeat;background-size:100% 95%;position:inline-block;display:flex;flex-direction:column;img{float:left;width:40%;height:400px;object-fit:cover;@media  (max-width:800px){{display:block;float:none;width:100%;}}}h3{width:50%;height:400px;float:right;padding:3px;@media  (max-width:800px){{display:block;float:none;width:100%;}}}"]);
